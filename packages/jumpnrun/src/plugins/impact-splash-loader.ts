import {igLoader} from '@city41/impact.ts/dist/loader';
import {ig} from '@city41/impact.ts/dist/impact';
import {rangeMap} from '@city41/impact.ts/dist/util';
...
export class ImpactSplashLoader extends igLoader {
  ...
  draw() {
    ...
    var comet = ImpactSplashLoader.PATHS_COMET as any;
    ...
    ctx.translate(
      -Math.random() * this._drawStatus * 7,
      -Math.random() * this._drawStatus * 5,
    );
  ...
  drawPaths(color: string, paths: Array<string | number[]>) {
